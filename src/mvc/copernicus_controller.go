...
func loadCopernicusImageData(w http.ResponseWriter, r *http.Request) {
	...
	response := queryCopernicusImageData(startLatitude, endLatitude, startLongitude, endLongitude, level)
...
func queryCopernicusImageData(startLatitude float64, endLatitude float64, startLongitude float64, endLongitude float64, level int64) []byte {
	...
	params.Add("ELEVATION", "0")
	params.Add("FORMAT", "image/png")
	params.Add("TOKEN", apiToken)
	params.Add("REQUEST", "GetMap")
	params.Add("CRS", "EPSG:4326")
	params.Add("BBOX", "30.05,-24.95,71.95,44.95")
	params.Add("WIDTH", "810")
	params.Add("HEIGHT", "495")
